...
def template_2a(photo_1, photo_2, model_name, shop_name_en, sizes, brand, logo=None):
    ...
    # --- 3. Shoe photos ---
    place_shoe(canvas, photo_1_rem, pos=(None,520), max_size=(800,450), angle=0, center_x=True)
    place_shoe(canvas, photo_2_rem, pos=(None,950), max_size=(800,450), angle=0, center_x=True)
