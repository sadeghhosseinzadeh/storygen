...
def template_2b(photo_1, photo_2, model_name, shop_name_en, sizes, brand, logo=None):
    ...
    # --- 4. Shoe photos ---
    place_shoe(canvas, photo_1_rem, pos=(None,190), max_size=(800,480), angle=0, center_x=True)
    place_shoe(canvas, photo_2_rem, pos=(None,1280), max_size=(800,480), angle=0, center_x=True)
